...
SECRET_KEY = 'django-insecure-6*46^z&q6m&33kxica659*&#*h7*r-s()%^8i=126c4n*z15o7'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'property_db',      # matches POSTGRES_DB in docker-compose
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/1",  # redis service in docker-compose
        "OPTIONS": {
